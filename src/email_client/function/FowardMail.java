...
public class FowardMail {
    
    Session sess;

    public FowardMail(Session sess) {
        this.sess = sess;
               
    }

    public void fowardEmail(String[] listTo, String[] listCC, String[] listBcc, String content, 
            String FileName, String subject, String from) throws NoSuchProviderException, MessagingException {
